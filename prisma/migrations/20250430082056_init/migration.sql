/*
  ...
  - A unique constraint covering the columns `[userDeviceId]` on the table `NotificationSetting` will be added. If there are existing duplicate values, this will fail.
  ...
  - Added the required column `userDeviceId` to the `NotificationSetting` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "modifiedAt" BIGINT NOT NULL DEFAULT 0,
ADD COLUMN     "userDeviceId" INTEGER NOT NULL;
